...
public class MainActivity extends AppCompatActivity implements
    ...
    ChargingBroadcastReceiver mCharginRecevier;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCharginRecevier = new ChargingBroadcastReceiver();
    }
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mCharginRecevier, mChargingIntentFilter);
    }
    ...
    protected void onPause() {
        super.onPause();
        unregisterReceiver(mCharginRecevier);
    }
