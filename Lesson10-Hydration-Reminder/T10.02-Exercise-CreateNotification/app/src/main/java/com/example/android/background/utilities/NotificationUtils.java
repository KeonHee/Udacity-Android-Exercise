...
public class NotificationUtils {
    ...
    public static final int WATER_REMINDER_PENDING_INTENT_ID = 3231;
    public static final int WATER_REMINDER_NOTIFICATION_ID = 1111;
    ...
    public static Bitmap largeIcon(Context contexts){
