...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        String addr = "1600 Amphitheatre Parkway, CA, United States";
        String addrQuery = "1600 Amphitheatre Parkway, CA, United States";
        Uri addressUriByBuilder = new Uri.Builder()
                .scheme("geo")
                .path("0,0")
                .appendQueryParameter("q",addrQuery)
                .build();
        Log.d("MainActivity","addressUriByBuilder : " + addressUriByBuilder.toString());

        Uri addressUriByParse = Uri.parse("geo:0,0?q=" + addr);
        Log.d("MainActivity","addressUriByParse : " + addressUriByParse.toString());

        showMap(addressUriByBuilder);
    }
